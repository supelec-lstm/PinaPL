...
# PERCEPTRON
#clang++ -std=c++11 -c perceptron/mathFunctions.cpp -o perceptronMathFunctions.o
#clang++ -std=c++11 -c perceptron/neuronNetwork.cpp -o perceptronNeuronNetwork.o
...
clang++ -std=c++11 -lz -o testBuild main.cpp mathFunctions.o neuronNetwork.o idxParser.o test.o
